...
import com.ongaku.jpop.member.MemberDTO;
...
class OngakuBoxApplicationTests {
    ...
    void insertProjectDummyData() {
        ...
        // DTO 클래스의 toEntity() 메소드를 활용
        MemberDTO dto = new MemberDTO();
        dto.setUsername("test");
        dto.setPassword("test1234");
        dto.setEmail("test@test.com");
        dto.toEntity();
        Member test = dto.toEntity();
        ...
        music1.setArtist("YOASOBI");
        music1.setDescription("최신 애니메이션 최애의 아이 오프닝 곡으로, 전 세계적인 붐을 일으킨 트렌디한 제이팝 음악입니다. 강력 추천!");
        ...
        music2.setArtist("Kenshi Yonezu (米津玄師)");
        music2.setDescription("드라마 '언내추럴'의 주제가로, 일본 레코드 협회 역사상 가장 빠른 속도로 밀리언 인증을 받은 서정적인 명곡입니다.");
        ...
        music3.setArtist("Yuuri (優里)");
        music3.setDescription("애절한 이별 감성을 담은 어쿠스틱 발라드로, 빌보드 재팬 연간 차트 1위를 기록하며 노래방에서 가장 많이 불리는 곡입니다.");
        ...
        music4.setArtist("Miki Matsubara (松原みき)");
        music4.setDescription("1979년에 발매되었으나 최근 틱톡과 글로벌 스트리밍에서 전 세계적인 역주행 신화를 쓴 전설적인 시티팝 장르 대표곡입니다.");
